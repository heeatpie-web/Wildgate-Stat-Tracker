...
import {
  ...
  normalizeShipKillPopupAutoDismissMs,
  normalizeSoundVolume,
  sanitizeMacroSequenceConfig,
...
const buildStorageDataFromState = (state: AppState) => ({
  ...
  settings: {
    ...
    macroSequenceConfig: state.macroSequenceConfig,
    ...
    shipKillPopupAutoDismissMs: state.shipKillPopupAutoDismissMs,
    ...
    try {
      ...
      const hydratedState = {
        state: {
          ...
          macroSequenceConfig: sanitizeMacroSequenceConfig(settings.macroSequenceConfig),
          ...
          shipKillPopupAutoDismissMs: normalizeShipKillPopupAutoDismissMs(settings.shipKillPopupAutoDismissMs),
