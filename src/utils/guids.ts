/**
 * @module guids
 * Hardcoded GUID → display name mappings for heroes, ships, weapons,
 * and equipment. Extracted from game telemetry. Unknown GUIDs are
 * tracked by createMappingSlice.registerUnknownId() for user resolution.
 */
export const HERO_GUIDS: Record<string, string> = {
    'C0C3960248AD43D20AA6DDA8AEB81424': 'Sal',
    'E7539B7C4483C338E55B15B102E2F006': 'Adrian',
    'E305EC254F7CD5BA4107A381E9BEA287': 'Venture'
};

export const SHIP_GUIDS: Record<string, string> = {
    '0BFFF89B44027290DC6348B95A6B0F11': 'Hunter'
};

export const WEAPON_GUIDS: Record<string, string> = {
...
export const EQUIPMENT_GUIDS: Record<string, string> = {
