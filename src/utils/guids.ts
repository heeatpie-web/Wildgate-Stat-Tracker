...
export const HERO_GUIDS: Record<string, string> = withGuidCaseAliases({
    ...
    '4BB6782A475B3FBA76ECA683DECBC23B': 'Kae',
    '39BEFBAF436F529669C207B5106D256A': 'Mophs',
    'D978177246E41E1DC58185AD36ADB864': 'Charlie',
    '282D534546A0DC63DDCE24A388C53B64': 'Ion',
    '130A8C544E4A13DBC33C9CBB47D4B36B': 'Sammo',
});

export const SHIP_GUIDS: Record<string, string> = withGuidCaseAliases({
    '0BFFF89B44027290DC6348B95A6B0F11': 'Hunter',
    'B16EF7D94FC7AE05ACA2999B2023138F': 'Hunter',
    '238FE96442789BC0C2E416BBDFDBCC52': 'Scout',
    '9299137344DC982A469564BDAD18711C': 'Solo Outlaw',
    '5F6F4E8647A82086A1DB2C8566E100DA': 'Outlaw',
    '9EC8F663442D6D70654E72A69AAE9912': 'Battle Scout',
    'C42238F241BB534AE55AF6BB7C88DDD9': 'Bastion',
});
...
export const EQUIPMENT_GUIDS: Record<string, string> = withGuidCaseAliases({
    ...
    '93071BFC425FC379C95B12961147AF9B': 'Plasma Can',
...
export const PERK_GUIDS: Record<string, string> = withGuidCaseAliases({
    ...
    '784E54BC47645CB5347E50A2544FD57D': 'Defender',
    '453697DC44F57CACA1F4BABC6171F3AD': 'Efficient Resourcing',
    '16CFDB1240084B87FBF8BA8D654C446D': 'Engineering',
    '67D507DF47BB41C6EE3DC5A4EA46B458': 'Sal Inventor',
    'DC33FBDD43EC6B059ADFCC931279E204': 'Sammo Defender',
    '14B840004BBC83F4A85CDFA9DF70AF0E': 'Kae Teleport',
    '77C7FADD4BE453847A719F923BA17737': 'Ion Smash',
    '54CA32F14C379EF35D17E4AA375BD65E': 'Venture Explorer',
    '5BE02211442D38DC8EE02784F0D736A2': 'Salvager',
    'F6547E4F4F949CD68E93878D5003DE5F': 'Mad Bomber',
});
