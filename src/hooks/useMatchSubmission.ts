...
export const buildSilentBackgroundOcrMatch = ({
    ...
    return {
        ...
        spectators: (combined.spectators && combined.spectators.length > 0) ? combined.spectators : match.spectators,
    ...
    const processFinalSubmission = useCallback(async (subType: string) => {
        ...
        try {
            ...
            const baseMatch: Match = {
                ...
                spectators: pendingMatchData?.spectators || undefined,
    ...
    const autoFinalizeResultScreenCapture = useCallback(async ({
        ...
        try {
            ...
            const baseSavedMatch: Match = {
                ...
                spectators: resolvedPendingMatchData.spectators || existingMatch.spectators || undefined,
