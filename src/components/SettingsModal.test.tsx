...
const storeState = {
  ...
  setGamepadModeEnabled: vi.fn(),
  virtualGamepadHotkeyEnabled: true,
  setVirtualGamepadHotkeyEnabled: vi.fn(),
  virtualGamepadMovement: 'NONE' as const,
  setVirtualGamepadMovement: vi.fn(),
  virtualGamepadButtons: [] as any[],
  setVirtualGamepadButtons: vi.fn(),
  virtualGamepadTriggers: [] as any[],
  setVirtualGamepadTriggers: vi.fn(),
  virtualGamepadStickIntensityPercent: 100,
  setVirtualGamepadStickIntensityPercent: vi.fn(),
  virtualGamepadTriggerIntensityPercent: 100,
  setVirtualGamepadTriggerIntensityPercent: vi.fn(),
  virtualGamepadHoldDurationMs: 180,
  setVirtualGamepadHoldDurationMs: vi.fn(),
  virtualGamepadRepeatCount: 1,
  setVirtualGamepadRepeatCount: vi.fn(),
