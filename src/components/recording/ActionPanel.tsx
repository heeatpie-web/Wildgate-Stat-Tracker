            ...
            <div className="mg-surface-high rounded-2xl p-4 border border-md-sys-outline/10 shadow-sm flex flex-col gap-4">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] opacity-60 font-medium">Auto-capture game entities</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex gap-2">
                    ...
                    >
                        ...
                        {isCapturing ? 'Capturing...' : isProcessing ? 'Processing...' : 'Smart Capture'}
                    </button>

                    {capturedScreenshots.length > 0 && (
                        <button
                            onClick={handleReviewBucket}
                            className="bg-md-sys-secondaryContainer text-md-sys-onSecondaryContainer px-4 rounded-xl font-bold text-[10px] uppercase tracking-widest relative overflow-visible"
                        >
                            Review
