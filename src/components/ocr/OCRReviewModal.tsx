...
export const OCRReviewModal: React.FC<OCRReviewModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-md-sys-surface1 rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="p-4 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-white">Review Captured Data</h2>
            ...
            <div className="bg-md-sys-surface2 rounded-2xl overflow-hidden">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-semibold text-white">Your Ship</span>
                </div>
            ...
            {expandedSections.teammates && (
              <div className="p-3 pt-0 space-y-2">
                {editedData.teammates.length === 0 ? (
                  <p className="text-xs text-white/40 italic">No teammates detected</p>
                ) : (
                  editedData.teammates.map((teammate, index) => (
                    ...
                    >
                      <input
                        ...
                        className="flex-1 bg-transparent text-white text-sm px-2 py-1 rounded-lg border border-white/10 focus:border-green-500/50 focus:outline-none"
                      />
            ...
            {expandedSections.opponents && (
              <div className="p-3 pt-0 space-y-3">
                {editedData.opponentTeams.length === 0 ? (
                  <p className="text-xs text-white/40 italic">No opponents detected</p>
                ) : (
                  editedData.opponentTeams.map((team, teamIndex) => (
                    <div key={teamIndex} className="bg-white/5 rounded-xl p-2">
